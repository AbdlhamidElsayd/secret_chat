                  ...
                  <li><!-- Task item -->
                    <a href="#">
                      ...
                      <div class="progress xs">
                        ...
                        <div class="progress-bar progress-bar-aqua" style="width: 55%" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>{{ $user->name }}</p>
          <!-- Status -->
          <a href="#"><i class="fa fa-circle text-success"></i> {{ __('common.Online') }}</a>
        </div>
      </div>
     ...
     {{-- <!-- search form (Optional) -->
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <a href="#"><i class="far fa-camera"></i> <span>{{ __('common.service') }}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route('service_create') }}">{{ __('common.create_service') }}</a></li>
            <li><a href="{{ route('service_index') }}">{{ __('common.all_services') }}</a></li>
          </ul>
        </li>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('email.create') }}">Create Email</a></li>
            @endpermission
            @permission('email-index')
            <li><a href="{{ route('email.index') }}">All Emails</a></li>
            @endpermission
          </ul>
        </li>

          <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>social</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('social.create') }}">Create social</a></li>
             @endpermission
             @permission('social-index')
            <li><a href="{{ route('social.index') }}">All social</a></li>
             @endpermission
          </ul>
        </li>

          <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Mobile</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('mobile.create') }}">Create mobile</a></li>
            @endpermission
             @permission('mobile-index')
            <li><a href="{{ route('mobile.index') }}">All mobile</a></li>
            @endpermission
          </ul>
        </li>

          <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Subscribe</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
         ...
         <li class="treeview">
         {{-- <a href="{{ route('setting.edit',$setting->id) }}"><i class="fa fa-link"></i> <span>Setting</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>--}}
